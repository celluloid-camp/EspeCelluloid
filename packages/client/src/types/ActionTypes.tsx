...
export enum ActionType {
  ...
  // Auto Detect
  PLAYER_SWITCH_AUTO_DETECTION = 'PLAYER_START_AUTO_DETECTION',
  // PLAYER_START_AUTO_DETECTION = 'PLAYER_START_AUTO_DETECTION',
  // PLAYER_STOP_AUTO_DETECTION = 'PLAYER_STOP_AUTO_DETECTION'
}
